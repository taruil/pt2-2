...
<style>
 .all{background:rgba(51,51,51,0.8); color:#FFF; min-height:100px; width:300px; position:fixed; display:none; z-index:9999; overflow:auto;}
</style>
...
<div id="alerr" style="background:rgba(51,51,51,0.8); color:#FFF; min-height:100px; width:300px; position:fixed; display:none; z-index:9999; overflow:auto;">
	...
	<div id="title">
      ...
      <?=$Total->q("select sum(`total`) from `total`")[0][0];?> <a href="index.php" style="float:right">回首頁</a> </div>
    <div id="title2" title="健康促進網-回首頁">
      <a href="index.php"><img src="icon/H-logo.jpg" style="width:100%"></a>
    </div>
